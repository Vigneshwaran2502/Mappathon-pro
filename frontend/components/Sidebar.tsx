...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div className="flex flex-col h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 w-80 shadow-lg z-10">
      ...
      <div className="p-4 space-y-4 overflow-y-auto flex-1">
        ...
        <button 
          ...
          className="w-full bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium py-2 px-4 rounded-md shadow transition flex items-center justify-center gap-2"
        >
          ...
          <div className="space-y-1">
            ...
            {availableLayers.map(layer => (
              <div 
                ...
                className={`flex items-center justify-between p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer transition ${activeLayers.includes(layer.layer_name) ? 'bg-brand-50 dark:bg-gray-800 border-l-4 border-brand-500' : ''}`}
